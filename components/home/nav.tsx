  ...
  return (
    <div className="fixed left-0 right-0 top-0 z-50 px-4 py-4">
      <div className="mx-auto max-w-fit">
        <div className="flex items-center gap-4 sm:gap-6 rounded-full border-2 bg-background/75 px-4 sm:px-6 py-2 backdrop-blur-sm supports-backdrop-filter:bg-background/60">
          <Link
            href="/"
